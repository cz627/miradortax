...
function Icon({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    style: style
  }, ICONS[name].split("M").filter(Boolean).map((d, i) => /*#__PURE__*/React.createElement("path", {
    key: i,
    d: "M" + d
  })));
}
...
function PortalMockup({
  ...
  const steps = [{
    t: "Belege & Kontoauszüge",
    d: "Automatisch importiert",
    pct: "100%",
    done: true
  }, {
    t: "Buchhaltung 2024",
    ...
    t: "Offenlegung Bundesanzeiger",
    d: "Wartet auf Freigabe",
    pct: "—"
  }];
  return /*#__PURE__*/React.createElement("div", {
    className: "mock"
    ...
    size: 12,
    sw: 2
  }), " app.miradortax.com")), /*#__PURE__*/React.createElement("div", {
    className: "mock__body"
  }, /*#__PURE__*/React.createElement("aside", {
    className: "mock__side"
  }, /*#__PURE__*/React.createElement("div", {
    className: "mock__brand"
  }, /*#__PURE__*/React.createElement("img", {
    src: "assets/icon-dark.png",
    alt: ""
  }), "Mirador"), nav.map(n => /*#__PURE__*/React.createElement("div", {
    key: n.t,
    className: "mock__navitem" + (n.active ? " is-active" : "")
  }, /*#__PURE__*/React.createElement(Icon, {
    name: n.ic,
    size: 16,
    className: "ic"
  }), " ", n.t))), /*#__PURE__*/React.createElement("div", {
    className: "mock__main"
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center"
    ...
    size: 12,
    sw: 2.2
  }), " Frist 31.07.")), /*#__PURE__*/React.createElement("div", {
    className: "mock__steps"
  }, steps.map(s => /*#__PURE__*/React.createElement("div", {
    key: s.t,
    className: "mock__step" + (s.done ? " done" : "") + (s.active ? " active" : "")
  }, /*#__PURE__*/React.createElement("span", {
    className: "mock__check"
  }, /*#__PURE__*/React.createElement(Icon, {
    name: s.done ? "check" : s.active ? "bolt" : "lock",
    size: 12,
    sw: 2.4
  })), /*#__PURE__*/React.createElement("div", {
    className: "mock__step-main"
  }, /*#__PURE__*/React.createElement("div", {
    className: "mock__step-t"
  }, s.t), /*#__PURE__*/React.createElement("div", {
    className: "mock__step-d"
