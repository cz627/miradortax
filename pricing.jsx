...
function computePrice({ beteiligungen = 2, transaktionen = 20, bilanzsumme = 100000, sel = {} } = {}) {
  ...
  if (beteiligungen <= 3 && transaktionen <= 20 && bilanzsumme <= 100000) { plan = "Holding S"; basePrice = 499; }
  else if (beteiligungen <= 10 && transaktionen <= 40 && bilanzsumme <= 300000) { plan = "Holding M"; basePrice = 999; }
  else if (beteiligungen <= 25 && transaktionen <= 100 && bilanzsumme <= 5000000) { plan = "Holding L"; basePrice = 1499; }
