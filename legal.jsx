...
function AGBPage() {
  return (
    <LegalPage title="Allgemeine Geschäftsbedingungen (AGB)" stand="Stand: 07.07.2026">
      ...
      <LP>1.1. Diese Allgemeinen Geschäftsbedingungen (AGB) gelten für alle Verträge, die Sie mit uns (nachfolgend der „Anbieter“) über unsere Webseite bzw. Online-Plattform Mirador Tax abschließen.</LP>
      ...
      <LP>4.3. Preisstruktur: Für die Nutzung der Plattform können einmalige und laufende Gebühren anfallen. Insbesondere wird eine einmalige Einrichtungsgebühr für die Freischaltung Ihres Zugangs erhoben. Darüber hinaus fällt pro Geschäftsjahr ein Nutzungsentgelt für die Erstellung Ihres Jahresabschlusses über die Plattform an. Eventuell angebotene Zusatzleistungen oder optionale Services können gesonderten Entgelten unterliegen. Die konkreten aktuellen Gebühren und Leistungsumfänge können Sie der Preisseite auf unserer Website entnehmen.</LP>
      <LP>4.4. Entstehung und Fälligkeit des Nutzungsentgelts: Das Nutzungsentgelt entsteht, sobald Sie die Dateneingabe im Portal vollständig durchgeführt, die Abschlussfragen beantwortet und den Vorgang durch Klick auf die Schaltfläche „Abschließen“ verbindlich eingereicht haben. Mit dieser Einreichung beauftragen Sie verbindlich und zahlungspflichtig die Erstellung des Jahresabschlusses für das betreffende Geschäftsjahr. Vor dem Klick auf „Abschließen“ werden Sie im Portal ausdrücklich darauf hingewiesen, dass die Einreichung zahlungspflichtig ist. Auf die spätere Freigabe, Genehmigung oder Verwendung der erstellten Entwürfe kommt es für die Entgeltpflicht nicht an; ebenso wenig entfällt das Entgelt, wenn Sie den Jahresabschluss anderweitig erstellen lassen oder von einer Weiterverwendung absehen.</LP>
      ...
      <LP>4.6. Zufriedenheitsgarantie: Melden Sie sich an und schließen den Prozess der Dateneingabe nicht durch Klick auf die Schaltfläche „Abschließen" ab, werden Ihnen keine Nutzungsentgelte berechnet. Das Nutzungsentgelt entsteht ausschließlich mit der verbindlichen Einreichung gemäß Ziffer 4.4.</LP>
