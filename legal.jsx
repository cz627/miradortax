...
function DatenschutzPage() {
  return (
    <LegalPage title="Datenschutzerklärung" stand="Stand: 12.04.2025">
      ...
      <LP>2.1 Beim Zugriff auf unsere Webseite werden automatisch Informationen allgemeiner Natur erfasst (z. B. Browsertyp, Betriebssystem, IP-Adresse, Domainname deines Internet Service Providers).</LP>
      <LP>2.2 Diese Informationen sind technisch notwendig, um die von dir angeforderten Inhalte korrekt bereitzustellen und fallen bei der Nutzung des Internets zwangsläufig an. Eine Zuordnung dieser Daten zu einer bestimmten Person findet nicht statt.</LP>

      <LH>3. Erhebung und Verarbeitung personenbezogener Daten</LH>
      <LP>Wir erheben personenbezogene Daten nur, wenn du uns diese von dir aus mitteilst – etwa bei Registrierung auf unserer Plattform, bei der Buchung unserer Dienstleistungen oder wenn du mit uns in Kontakt trittst (z. B. per Kontaktformular oder E‑Mail). Folgende personenbezogene Daten können je nach Aktion erhoben werden:</LP>
      <LP><b>Registrierung auf der Plattform:</b> Name des Unternehmens und des Geschäftsführers, Anschrift, E‑Mail-Adresse, ggf. Telefonnummer (sofern freiwillig angegeben), sowie Zugangsdaten (Benutzername, Passwort). Diese Daten verwenden wir, um dein Nutzerkonto einzurichten und zu verwalten, sowie um dir Zugang zu unseren Services zu ermöglichen.</LP>
      <LP><b>Nutzung der Plattform:</b> Alle geschäftlichen Daten, finanzielle Kennzahlen und Dokumente, die du in Mirador Tax eingibst oder hochlädst (z. B. Buchhaltungsdaten, Belege, Jahresabschluss-Entwürfe), werden von uns gespeichert, um die Funktionen der Software zu erbringen. Wir behandeln diese Unternehmensdaten selbstverständlich vertraulich und nutzen sie ausschließlich zur Bereitstellung der vertraglichen Leistung.</LP>
      <LP><b>Kontaktaufnahme:</b> Wenn du per E‑Mail oder über ein Kontaktformular Anfragen an uns stellst, speichern und verwenden wir die von dir gemachten Angaben (z. B. Name, E‑Mail-Adresse, Anfrageinhalt), um deine Anfrage zu bearbeiten und zu beantworten.</LP>
      <LP>Wir verwenden deine personenbezogenen Daten jeweils ausschließlich für den angegebenen Zweck und im Rahmen der gesetzlichen Bestimmungen. Eine Übermittlung deiner personenbezogenen Daten an Dritte erfolgt nur in folgenden Fällen: (a) wenn dies zur Vertragserfüllung erforderlich ist (z. B. Übermittlung von Abschlussdaten an eine von dir ausgewählte Steuerkanzlei), (b) wenn wir gesetzlich dazu verpflichtet sind, oder (c) falls du ausdrücklich eingewilligt hast. In allen anderen Fällen werden deine Daten nicht an Dritte weitergegeben.</LP>

      <LH>4. Cookies</LH>
      <LP>4.1 Unsere Webseite verwendet „Cookies“ – kleine Textdateien, die auf deinem Endgerät gespeichert werden, um bestimmte Funktionen der Webseite zu ermöglichen oder zu verbessern.</LP>
      <LP>4.2 Du kannst das Setzen von Cookies durch entsprechende Einstellungen in deinem Browser verhindern. Allerdings kann dies zu Funktionseinschränkungen führen.</LP>
      <LP>4.3 Über Art und Zweck der eingesetzten Cookies wirst du ggf. in unserem Cookie-Banner oder einer separaten Cookie-Richtlinie informiert.</LP>
      ...
      <LP><b>Vertragserfüllung (Art. 6 Abs. 1 lit. b DSGVO):</b> Wenn die Verarbeitung deiner Daten für die Erfüllung eines Vertrags, dessen Vertragspartei du bist, oder zur Durchführung vorvertraglicher Maßnahmen erforderlich ist (z. B. Datenverarbeitung im Rahmen der Nutzung der Mirador Tax Software oder bei Registrierung).</LP>
      <LP><b>Einwilligung (Art. 6 Abs. 1 lit. a DSGVO):</b> Soweit du uns eine ausdrückliche Einwilligung zur Verarbeitung deiner Daten erteilt hast, verarbeiten wir die Daten im Umfang und zu den Zwecken, die in der Einwilligungserklärung genannt sind (z. B. Zusendung eines Newsletters oder das Setzen optionaler Analyse-/Marketing-Cookies). Eine erteilte Einwilligung kannst du jederzeit mit Wirkung für die Zukunft widerrufen (siehe Punkt 7.3 unten).</LP>
      ...
      <LP><b>Kontaktdaten bei Anfragen:</b> Angaben, die du uns im Rahmen von Kontaktanfragen gibst, speichern wir so lange, wie es für die Bearbeitung deiner Anfrage erforderlich ist. Sobald deine Anfrage vollständig erledigt ist und keine weitere Notwendigkeit zur Speicherung besteht, werden die Daten gelöscht.</LP>
      <LP><b>Newsletter-Daten:</b> Wenn du dich für einen Newsletter angemeldet hast, speichern wir deine E‑Mail-Adresse und ggf. weitere freiwillige Angaben so lange, bis du deine Einwilligung widerrufst und dich vom Newsletter abmeldest.</LP>
      ...
      <LP>7.1 Du hast das Recht, Auskunft über deine bei uns gespeicherten personenbezogenen Daten zu erhalten.</LP>
      <LP>7.2 Du hast das Recht auf Berichtigung, Löschung („Recht auf Vergessenwerden“), Einschränkung der Verarbeitung sowie Widerspruch gegen die Verarbeitung.</LP>
      <LP>7.3 Darüber hinaus kannst du deine Einwilligung zur Datenverarbeitung jederzeit mit Wirkung für die Zukunft widerrufen.</LP>
      <LP>7.4 Bitte wende dich in diesen Fällen an den unter Punkt 1.1 genannten Verantwortlichen.</LP>

      <LH>8. Datensicherheit</LH>
      <LP>Mirador Tax verwendet technische und organisatorische Sicherheitsmaßnahmen, um deine Daten vor zufälliger oder vorsätzlicher Manipulation, Verlust, Zerstörung oder dem unbefugten Zugriff Dritter zu schützen. Unsere Sicherheitsmaßnahmen werden entsprechend der technologischen Entwicklung fortlaufend verbessert. Die Übertragung sensibler Informationen (z. B. Login-Daten) erfolgt verschlüsselt (SSL-/TLS-Verschlüsselung). Bitte beachte, dass die Datenübertragung im Internet (z. B. bei der Kommunikation per E‑Mail) Sicherheitslücken aufweisen kann; ein lückenloser Schutz der Daten vor dem Zugriff durch Dritte ist nicht möglich.</LP>
...
function AGBPage() {
  return (
    <LegalPage title="Allgemeine Geschäftsbedingungen (AGB)" stand="Stand: 05.10.2025">
      <LH>1. Geltungsbereich</LH>
      <LP>1.1. Diese Allgemeinen Geschäftsbedingungen (AGB) gelten für alle Verträge, die du mit uns (nachfolgend der „Anbieter“) über unsere Webseite bzw. Online-Plattform Mirador Tax abschließt.</LP>
      ...
      <LP>2.1. Digitaler Service: Mirador Tax betreibt eine Online-Plattform als digitaler Technologiedienstleister. Über diese Plattform stellen wir dir Software-Funktionen zur Verfügung, mit denen du deine unternehmensbezogenen Daten einfach erfassen, verwalten und für steuerrelevante Zwecke aufbereiten kannst. Insbesondere ermöglicht Mirador Tax die automatische Erstellung von Dokumenten – etwa Entwürfen von Jahresabschlüssen (Bilanz, GuV, Anhang) – auf Basis deiner Eingaben. Außerdem unterstützen wir dich durch technische Funktionen bei der Vorbereitung der gesetzlichen Pflichten deiner Gesellschaft (z. B. Erinnerungen an Offenlegungspflichten und Fristen nach deutschem Recht).</LP>
      <LP>2.2. Keine Steuer- oder Rechtsberatung: Mirador Tax erbringt selbst keine Steuerberatung oder Rechtsberatung. Eine individuelle steuerliche oder rechtliche Beratung erfolgt – sofern von dir gewünscht – ausschließlich durch eigenständige, unabhängige Steuerberater, Rechtsanwälte oder Wirtschaftsprüfer, mit denen du bei Bedarf separat einen Vertrag abschließt. Mirador Tax übernimmt keinerlei steuerberatende Tätigkeit im Sinne des Steuerberatungsgesetzes und gibt keine konkreten Handlungsempfehlungen für Einzelfälle. Sämtliche Informationen und Auswertungen auf der Plattform sind allgemeiner Natur und ersetzen keine professionelle Beratung.</LP>
      <LP>2.3. Vermittlung externer Berater: Verträge über steuerliche oder rechtliche Beratungsleistungen kommen ausschließlich zwischen dir und dem jeweiligen externen Berater zustande. Mirador Tax tritt lediglich als Vermittlungs- und Kommunikationsplattform auf. Wir sind an solchen Beratungsverträgen weder als Vertragspartei noch als Vertreter beteiligt. Nach Abschluss eines Nutzungsvertrags über unsere Plattform kannst du bei Bedarf Angebote von kooperierenden Steuerkanzleien einholen. Nimmst du ein solches Angebot an, kommt der Beratungsvertrag direkt zwischen dir und der ausgewählten Kanzlei zustande. Mirador Tax übermittelt in diesem Fall deine Annahmeerklärung an den Berater und stellt technische Kommunikations- und Datenräume für den Austausch von Unterlagen bereit.</LP>
      <LP>2.4. Inhaltliche Eigenverantwortung des Nutzers: Alle inhaltlichen Angaben, die über die Mirador Tax Plattform verarbeitet werden (z. B. von dir eingegebene Zahlen, Klassifizierungen von Geschäftsvorfällen, steuerliche Einordnungen), werden von dir selbst eingegeben und von dir final überprüft sowie freigegeben. Du bist dafür verantwortlich, dass diese Angaben richtig, vollständig und aktuell sind. Der Anbieter schuldet nicht die inhaltliche Überprüfung oder Richtigkeit deiner Eingaben. Du bleibst allein verantwortlich für die sachliche Korrektheit der Daten sowie für die fristgerechte Erstellung und Übermittlung deiner Steuererklärungen, Jahresabschlüsse oder sonstigen Meldungen an Behörden (z. B. Finanzamt oder Bundesanzeiger). Mirador Tax stellt dir lediglich die technischen Werkzeuge zur Verfügung und ersetzt weder einen Steuerberater noch einen Wirtschaftsprüfer.</LP>
      <LP>2.5. Hinweis auf externe Beratung: Wenn du individuelle Fragen zur steuerlichen oder rechtlichen Beurteilung deiner Situation hast, solltest du einen zugelassenen Steuerberater, Rechtsanwalt oder Wirtschaftsprüfer hinzuziehen. Gern unterstützen wir dich auf Wunsch bei der Kontaktaufnahme zu einer geeigneten Kanzlei. Ein eventuelles Mandatsverhältnis kommt dabei ausschließlich zwischen dir und der von dir beauftragten Kanzlei zustande – nicht mit Mirador Tax.</LP>
      <LP>2.6. Support und Helpdesk: Der Anbieter stellt einen Support- und Helpdesk-Service für technische oder anwendungsbezogene Fragen zur Nutzung der Plattform bereit. Bei Problemen oder Fragen kannst du dich beispielsweise per E-Mail oder über bereitgestellte Support-Funktionen an uns wenden. Unser Support umfasst ausschließlich die Unterstützung bei der Nutzung der Plattform und stellt keine steuerliche oder rechtliche Beratung dar.</LP>

      <LH>3. Registrierung & Nutzerkonto</LH>
      <LP>3.1. Registrierung: Für die Nutzung der Plattform ist eine Registrierung erforderlich. Du bist verpflichtet, alle im Registrierungsprozess abgefragten Angaben wahrheitsgemäß, genau und vollständig anzugeben und diese Daten bei Bedarf aktuell zu halten. Wir behalten uns vor, einen Nachweis über deine Unternehmer-Eigenschaft oder weitere Informationen zur Verifizierung zu verlangen, bevor wir dein Konto freischalten.</LP>
      <LP>3.2. Nutzerkonto: Dein Nutzerkonto ist personalisiert und nicht übertragbar. Zugangsdaten (insbesondere dein Passwort) sind vertraulich zu behandeln und vor dem Zugriff Dritter zu schützen. Du trägst die Verantwortung für alle Handlungen, die unter Verwendung deiner Zugangsdaten bzw. über dein Nutzerkonto vorgenommen werden. Sollten dir Anzeichen eines Missbrauchs deines Kontos bekannt werden, hast du uns umgehend zu informieren.</LP>

      <LH>4. Preise und Zahlungsbedingungen</LH>
      <LP>4.1. Preise: Sämtliche Preise für die Nutzung von Mirador Tax und ggf. zusätzlichen Leistungen werden auf unserer Website ausgewiesen. Alle Preisangaben verstehen sich in Euro und enthalten die gesetzliche Umsatzsteuer, soweit anwendbar.</LP>
      ...
      <LP>4.3. Preisstruktur: Für die Nutzung der Plattform können einmalige und laufende Gebühren anfallen. Insbesondere wird eine einmalige Einrichtungsgebühr für die Freischaltung deines Zugangs erhoben. Darüber hinaus fällt pro Geschäftsjahr ein Nutzungsentgelt für die Erstellung deines Jahresabschlusses über die Plattform an. Eventuell angebotene Zusatzleistungen oder optionale Services können gesonderten Entgelten unterliegen. Die konkreten aktuellen Gebühren und Leistungsumfänge kannst du der Preisseite auf unserer Website entnehmen.</LP>
      <LP>4.4. Erfolgs-Garantie (Zufriedenheitsgarantie): Mirador Tax bietet eine Erfolgs-Garantie für die Nutzung der Plattform. Das bedeutet, das Nutzungsentgelt für die Erstellung deines Jahresabschlusses wird nur fällig, wenn du mit unserer Plattform zufrieden bist und den Jahresabschluss-Prozess über Mirador Tax erfolgreich abschließt. Entscheidest du dich, den Prozess nicht abzuschließen, oder bist du nicht zufrieden, entfällt dieses Nutzungsentgelt für das betreffende Geschäftsjahr.</LP>
      ...
      <LP>5.1. Digitale Inhalte: Soweit wir digitale Inhalte oder Funktionen schulden, werden diese in der Regel unmittelbar nach erfolgreicher Zahlung bzw. Freischaltung deines Zugangs bereitgestellt (z. B. durch Zugriff über dein Nutzerkonto und/oder per elektronischer Bereitstellung von Dokumenten).</LP>
      <LP>5.2. Vermittlung von Beratungsangeboten: Nach Abschluss des Nutzungsvertrags über unsere Plattform erhältst du auf Wunsch unverbindliche Angebote von kooperierenden Steuerberatern oder Kanzleien. Entscheidest du dich, ein solches Angebot anzunehmen, kommt der entsprechende Beratungsvertrag ausschließlich zwischen dir und dem ausgewählten Berater zustande. Mirador Tax hat auf die inhaltliche Ausgestaltung dieser Angebote keinen Einfluss.</LP>
      <LP>5.3. Rolle von Mirador bei Beratungsverträgen: Nimmst du ein Angebot eines externen Beraters an, leitet Mirador Tax deine Annahmeerklärung an den jeweiligen Berater weiter. Zudem stellen wir euch für die Zusammenarbeit technische Kommunikationsmöglichkeiten und geschützte Datenräume auf unserer Plattform bereit. Mirador Tax übernimmt jedoch keine Verantwortung für die tatsächliche Durchführung oder Qualität der Beratungsleistungen und haftet nicht für etwaige Fehler der externen Berater.</LP>

      <LH>6. Laufzeit & Kündigung</LH>
      <LP>6.1. Vertragslaufzeit: Der Nutzungsvertrag über Mirador Tax wird auf unbestimmte Zeit geschlossen und beginnt mit der Freischaltung deines Zugangs.</LP>
      ...
      <LP>7.4. Haftung für Nutzerinhalte: Mirador Tax übernimmt keine Haftung für die Inhalte, Zahlenwerke oder Dokumente, die du selbst auf der Plattform eingibst, erstellst oder generierst. Du bist verpflichtet, die von der Software automatisiert erstellten Auswertungen (insbesondere Entwürfe von Jahresabschlüssen) auf Plausibilität und Richtigkeit zu prüfen. Für Fehler, Unvollständigkeiten oder Versäumnisse bei der Eingabe deiner Daten – und die daraus resultierenden Folgen, wie fehlerhafte Jahresabschlüsse oder Fristversäumnisse gegenüber Behörden – haftet Mirador Tax nicht.</LP>
      <LP>7.5. Keine Haftung für externe Beratung: Soweit du Beratungsleistungen externer Steuerberater oder Kanzleien in Anspruch nimmst, übernimmt Mirador Tax hierfür keine Haftung. Etwaige Haftungsansprüche im Zusammenhang mit solchen Beratungsverträgen sind direkt gegenüber dem jeweiligen Berater geltend zu machen.</LP>

      <LH>8. Änderung der AGB</LH>
      <LP>8.1. Mirador Tax behält sich vor, diese AGB mit Wirkung für die Zukunft zu ändern oder zu ergänzen, sofern hierfür ein triftiger Grund besteht (z. B. Gesetzesänderungen, Erweiterung der Leistungen, Änderung der Rechtsprechung oder der Marktgegebenheiten). Über geplante Änderungen der AGB werden wir dich spätestens sechs Wochen vor deren Inkrafttreten in Textform (z. B. per E-Mail) informieren. Wenn du den Änderungen nicht binnen vier Wochen ab Zugang der Änderungsmitteilung widersprichst, gelten die neuen AGB ab dem angekündigten Zeitpunkt als akzeptiert.</LP>
      <LP>8.2. Widersprichst du fristgerecht den Änderungen, hat jede Partei das Recht, den Nutzungsvertrag noch vor Inkrafttreten der Änderung mit Wirkung zu diesem Zeitpunkt zu kündigen. Andere Kündigungsrechte bleiben unberührt. Im Falle einer Kündigung aufgrund eines AGB-Widerspruchs werden bereits gezahlte Entgelte, die auf die Zeit nach Vertragsende entfallen, anteilig erstattet.</LP>

      <LH>9. Schlussbestimmungen</LH>
      <LP>9.1. Anwendbares Recht und Gerichtsstand: Es gilt ausschließlich deutsches Recht unter Ausschluss des UN-Kaufrechts (CISG).</LP>
    </LegalPage>
  );
}
